        ...
        <>
            <header className="header">
                <div className="header-container">
                    <HeaderTop setModalActive={changeBoolean} />
                    ...
                    <Grid item md={9} sx={{ color: '#77797c' }}>
                        <Grid container sx={{ maxWidth: '850px' }}>
                            ...
                            <Grid item md={12}>
                                ...
                                >
                                    Donec sed lacus eu massa commodo interdum
                                    non id mauris. Etiam eu dignissim elit.
                                    Nulla cursus neque adictum quam tristique
                                    ac. Pellentesque habitant morbi tristique
                                    senectus et netus lalesuada fames ac turpis
                                    egestas. Donec ornare enim felis, non
                                    faucibus eros mattis vel. Suspendisse
                                    sollicitudin, nisi non interdum pharetra,
                                    libero lectus sollicitudin est, quis
                                    imperdiet nibh nulla non metus. Fusce
                                    accumsan in leo eu porttitor. Sed eget neque
                                    aliquam sequat bibendum.
                                </Typography>
                            </Grid>
                            <Grid
                                item
